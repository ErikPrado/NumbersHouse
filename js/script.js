...
function translateEspanol() {
    pCalc.innerHTML = 'Calculadora';
    pNavSit.innerHTML = 'Inicio > Herramientas > <span class="page-slct">Calculadora</span>';
    hSubTxt.innerHTML = 'NUMBERS HOUSE PRESENTA:'
    hTxt.innerHTML = "Historial de la Calculadora"
    pHistory1.innerHTML ='<span class="spc-left"></span>Actualmente, las funciones de las calculadoras no se limitan a realizar cálculos de operadores aritméticos, pero ¿sabías que las primeras calculadoras inventadas sólo se limitaban a realizar cálculos de sumas y restas? <br> La Numbers House te invita a leer el resumen de la historia de la calculadora:';
    pHistory2.innerHTML ='<span class="spc-left"></span>En definitiva, la primera calculadora inventada no es aquella con la que estamos acostumbrados a interactuar. Incluso su nombre era diferente. Hablamos de Abacus, la primera calculadora de la historia. Su creación revolucionó las matemáticas, fue creada por los chinos en el siglo VI a.C., esta herramienta tenía el poder de realizar cálculos matemáticos de suma y resta.';
    pHistory3.innerHTML ='<span class="spc-left"></span>En 1942, el francés Blaise Pascal logró la hazaña de crear una nueva máquina automática para realizar cálculos. Pascal era hijo de un recaudador de impuestos, quería ayudar a su padre a mejorar su desempeño en sus servicios, gracias a ello logró desarrollar una calculadora automática, sin embargo, similar al Ábaco, esta herramienta solo podía realizar cálculos de sumas y restas.';
    pHistory4.innerHTML ='<span class="spc-left"></span>Casi 30 años después, en 1671 en Alemania, el filósofo y matemático Gottfried Wilhelm Von Leibniz mejoró el proyecto de Pascal y desarrolló un mecanismo llamado “rueda graduada”. Su obra fue una calculadora capaz de realizar cálculos de sumas, restas, multiplicaciones, divisiones e incluso extraer la raíz cuadrada.';
    pHistory5.innerHTML ='<span class="spc-left"></span>Cabe mencionar que todas las calculadoras inventadas hasta ahora eran de gran tamaño, ninguna cabía en nuestros bolsillos. Este hecho cambió en 1947, cuando el austriaco Curt Herztark desarrolló el diseño de la primera calculadora mecánica, reduciendo su tamaño a una taza.';
    pHistory6.innerHTML ='<span class="spc-left"></span>Estas fueron las principales creaciones y modificaciones de las calculadoras, a partir de 1973 surgieron las calculadoras electrónicas. Con el paso de los años fueron surgiendo versiones más evolucionadas de estas herramientas, hasta convertirse en lo que estamos acostumbrados en nuestra vida diaria. <br> <span>Artículo publicado el 20 de mayo de 2024.</span>';
...
function translatePortugues() {
    pCalc.innerHTML = 'Calculadora';
    pNavSit.innerHTML = 'Inicio > Ferramentas > <span class="page-slct">Calculadora</span>';
    hSubTxt.innerHTML = 'NUMBERS HOUSE APRESENTA:'
    hTxt.innerHTML = "História da Calculadora"
    pHistory1.innerHTML ='<span class="spc-left"></span>Atualmente, as funções das calculadora não se limita apenas em realizar cálculos de operadores aritméticos, mas você sabia que as primeiras calculadoras inventadas só se limitavam em realizar cálculos de adição e subtração?<br> A Numbers House te convida para ler o resumo da história da calculadora:';
    pHistory2.innerHTML ='<span class="spc-left"></span> Em resumo, a primeira calculadora inventada não é essas que estamos acostumados a interagir. Até o seu nome era diferente.Estamos falando do Ábaco, a primeira calculadora da história. Sua criação revolucionou a matemática, foi criada pelos chineses no século 6 a.C, essa ferramenta tinha o poder de realizar cálculos matemáticos de adição e subtração.';
    pHistory3.innerHTML ='<span class="spc-left"></span> Em 1942, o francês Blaise Pascal obteve a façanha de criar uma nova máquina automática para realizar cálculos. Pascal era filho de um cobrar de impostos, queria ajudar seu pai a melhorar seu desempenho em seus serviços, como resultado conseguiu desenvolver uma calculadora automática, porém, semelhante ao Ábaco, essa ferramenta só conseguia realizar cálculos de adição e subtração.';
    pHistory4.innerHTML ='<span class="spc-left"></span> Passaram quase 30 anos depois, no ano de 1671 na Alemanha, o filosofo e matemático Gottfried Wilhelm Von Leibniz melhorou o projeto  de Pascal desenvolveu um mecanismo denominado de “roda graduada”. Sua obra era uma calculadora capaz de realizar cálculos de adição, subtração, multiplicação, divisão e até mesmo extrair a raiz quadrada.';
    pHistory5.innerHTML ='Vale ressaltar que todas as calculadoras inventadas até agora eram de grande porte, nenhuma era capaz de caber em nossos bolsos.  Esse fato muda em 1947, quando o austríaco Curt Herztark desenvolveu o projeto da primeira calculadora mecânica, reduzindo o seu  tamanho para um copo.';
    pHistory6.innerHTML ='Essas foram as principais criações e modificações das calculadoras, a partir do ano de 1973 surgiu as calculadoras eletrônicas. Conforme o decorrer dos anos surgia mais versões evoluída dessas ferramentas, até se transformar no que estamos acostumados em nosso cotidiano. <br> <span>Artigo publicado em 20 de maio de 2024. </span>';
